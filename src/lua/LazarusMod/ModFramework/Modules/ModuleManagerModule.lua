Script.Load("lua/LazarusMod/ModFramework/Modules/FrameworkModule.lua")
Script.Load("lua/LazarusMod/Modules.lua")
...
function ModuleManagerModule:Initialize(framework)
    ...
    -- Load modules
    local moduleFunc = GetModFrameworkModulesLazarusMod
    local moduleFuncName = "GetModFrameworkModulesLazarusMod"
