Script.Load("lua/LazarusMod/ModFramework/Utils.lua")
Script.Load("lua/LazarusMod/Config.lua")

-- Modules
Script.Load("lua/LazarusMod/ModFramework/Modules/ModuleManagerModule.lua")
Script.Load("lua/LazarusMod/ModFramework/Modules/LoggerModule.lua")
Script.Load("lua/LazarusMod/ModFramework/Modules/VersioningModule.lua")
Script.Load("lua/LazarusMod/ModFramework/Modules/EnumUtilitiesModule.lua")
Script.Load("lua/LazarusMod/ModFramework/Modules/TechHandlerModule.lua")

class 'ModFramework'

local modFrameworkVersion = "1.1.2"

function ModFramework:Initialize(vm, filehook)
    self.modName = "LazarusMod"
    ...
    -- Load config
    local configFunc = GetModFrameworkConfigLazarusMod
    local configFuncName = "GetModFrameworkConfigLazarusMod"
